    ...
    if (!isInit && old) {   //当初始化和old没有值时不响应   old没有值表示是第一次初始化的时候
        ...
        switch (step) {
            ...
            case TBMB_DEMO_STEP01:
                controller = [[TBMBDemoStep1ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP02:
                controller = [[TBMBDemoStep2ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP03:
                controller = [[TBMBDemoStep3ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP04:
                controller = [[TBMBDemoStep4ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP05:
                controller = [[TBMBDemoStep5ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP06:
                controller = [[TBMBDemoStep6ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
            case TBMB_DEMO_STEP07:
                controller = [[TBMBDemoStep7ViewController alloc]
                                                           initWithNibName:nil
                                                                    bundle:nil];
                break;
        }
...
- (void)loadView {
    [super loadView];
    TBMBNavView *navView = [[TBMBNavView alloc]
